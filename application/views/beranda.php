   ...
   <!--  <div id="preloader">
    ...
    <section class="welcome-area">
        <div class="welcome-slides owl-carousel">
            ...
            <img src="<?php echo base_url()?>assets/img/bg-img/1.jpg);">
            </div>
                    ...
                    <div class="row h-100 align-items-center">
                        ...
                        <div class="col-12 col-lg-8 col-xl-6">
                            <div class="welcome-text">
                                ...
                                <p data-animation="bounceInUp" data-delay="500ms">Seminar Informatika Aplikatif Polinema (SIAP) ditujukan sebagai sarana bagi mahasiswa untuk mempublikasikan artikel ilmiah mengenai Pengembangan Aplikasi Teknologi Informasi atau Teknik Informatika Aplikatif.</p>
